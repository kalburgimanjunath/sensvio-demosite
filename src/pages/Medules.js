    ...
    <>
      <section className="first_section">
        ...
        <div className="container text-white">
          <div className="row">
            <div className="row" style={{ background: "#102d2d" }}>
            ...
            <div className="row" style={{ background: "#162e50" }}>
              <div className="columns">
                <div className="column">
          ...
          <div className="row">
            <div className="row" style={{ background: "#351854" }}>
              <div className="columns">
                <div className="column">
            ...
            <div className="row" style={{ background: "#41244b" }}>
              <div className="columns">
                <div className="column">
